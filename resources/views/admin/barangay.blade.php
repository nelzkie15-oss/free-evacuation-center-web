         ...
         <section class="content">
            <div class="container-fluid">
               <div class="card card-info">
                 ...
                 @if(session()->has('update-completed2'))
                 <div class="alert alert-success">
                    {{ session()->get('update-completed2') }}
                 </div>
                @endif

                @if(session()->has('delete-completed2'))
                <div class="alert alert-success">
                   {{ session()->get('delete-completed2') }}
                </div>
               @endif

                  <!-- form start -->
                  <form action="{{ route('admin.addbarangayinformation') }}" method="post">
                     @csrf
                     <div class="card-body">
                        <div class="row">
                           <div class="col-md-3">
                              ...
                              <div class="row">
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control @error('barangay_name') is-invalid @enderror" name="barangay_name" placeholder="Barangay name">
                                    </div>
                                    @error('barangay_name')
