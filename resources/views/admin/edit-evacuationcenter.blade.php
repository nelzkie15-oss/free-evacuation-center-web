            ...
            <div class="container-fluid">
               <div class="card card-info">
                 ...
                 @endif
                  ...
                  <!-- form start -->
                    <form action="{{ route('admin.evacuationcenter.update', $eCenter->id) }}" method="post">
                     @csrf
                     <div class="card-body">
                        <div class="row">
                           <div class="col-md-3">
                              ...
                              <div class="row">
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control @error('center_name') is-invalid @enderror" name="center_name" value="{{ $eCenter->center_name }}" placeholder="Center Name">
                                    </div>
                                    @error('center_name')
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label>Address</label>
                                       <textarea class="form-control @error('address') is-invalid @enderror" name="address" width="100">{{ $eCenter->address }}</textarea>
                                    </div>
                                    @error('address')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                 @enderror
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control @error('contact_info') is-invalid @enderror" name="contact_info" value="{{ $eCenter->contact_info }}" placeholder="ex. 09827373213">
                                    </div>
                                    @error('contact_info')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                 @enderror
