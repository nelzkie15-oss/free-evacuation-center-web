         ...
         <section class="content">
            <div class="container-fluid">
               <div class="card card-info">
                  <!-- form start -->
                  <form action="{{ route('admin.calamitytype.update', $ctype->id) }}" method="post">
                     @csrf
                              ...
                              <div class="row">
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control @error('calamity_name') is-invalid @enderror" name="calamity_name" value="{{ $ctype->calamity_name }}"   placeholder="Calamity name">
                                    </div>
                                    @error('calamity_name')
